"""
Django settings for gensync_42766 project.
...
ROOT_URLCONF = 'gensync_42766.urls'
...
WSGI_APPLICATION = 'gensync_42766.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gensync_42766 API",
    "DESCRIPTION": "API documentation for gensync_42766 App",
    "VERSION": "v1",
}
